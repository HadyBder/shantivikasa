...
!endif
!ifndef OUTPUT_FILE
 !define OUTPUT_FILE "../release/ShantiVikasa-Setup-1.0.1.exe"
!endif
!ifndef APP_ICON
...
Section "Install"
 ...
 FileWrite $0 "ShantiVikasa-1.0.1"
 FileClose $0
 ...
 WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\ShantiVikasa" "DisplayVersion" "1.0.1"
